(function () {
  ...
  const reviews = [
    {
      ...
      date: 'a year ago',
      text: 'My car was really rusty by the wheels. 616 cut out the junk areas and replaced the metal. Then they coated it with bed liner before match painting it. While they understandably couldn’t guarantee it won’t rust again in a few years, they did excellent work.'
    },
    {
      name: 'Andrew Van Liere',
      meta: 'Local Guide · 62 reviews · 4 photos',
      date: '7 months ago',
      text: 'Great price. May not have the curb appeal of some big name body shops, but the price for the work they did was great.'
    },
    {
      name: 'CJ Edwards',
      meta: 'Local Guide · 9 reviews · 2 photos',
      date: '2 years ago',
      text: 'First time going to a body shop. I was skeptical at first, but Rebecca and her team did an amazing job. She kept me informed and updated during the whole repair/shipping process. The work they did on my car was perfect, and I appreciate how kind the entire staff was to me. Would recommend for sure!'
    },
    {
      name: 'John DenBraber',
      meta: '4 reviews · 1 photo',
      date: 'a year ago',
      text: 'Rebecca and the team did a great job on both my vehicles within a month of each other. Pricing was great, and the communication during the whole process gave me confidence my vehicles were in great hands!'
    },
    {
      name: 'Ethan H',
      meta: 'Local Guide · 17 reviews',
      date: '3 years ago',
      text: 'Brought my 2016 GMC Terrain here to get two fender panels installed and painted as well as some paint work on a few other parts of my vehicle. The guys did an excellent job! My SUV looks new again. Very thankful I brought my vehicle here. I highly recommend this shop!'
    },
    {
      name: 'Ryan Karadsheh',
      meta: '4 reviews',
      date: '3 years ago',
      text: 'These guys are amazing. They do top-notch quality work, competitive pricing, and they are courteous and professional. I’m a used car dealer and I’ve been through my fair share of body shops. These guys are by far the best in town.'
    },
    {
      name: 'Chris Thompson',
      meta: 'Local Guide · 11 reviews · 1 photo',
      date: '2 years ago',
      text: 'If you are in the greater Grand Rapids area and are looking for a quality and trustworthy body shop, I highly recommend 616 Auto Body. I have used them multiple times and they have always done an outstanding job for me. Courteous, professional, and affordable.'
    },
    {
      name: 'Doug Draper',
      meta: '1 review',
      date: '2 years ago',
      text: 'Great place to do business with! I would recommend them always. My truck they repaired looks awesome! They went above and beyond for me.'
    },
    {
      name: 'Vicente Villarreal',
      meta: 'Local Guide · 22 reviews · 10 photos',
      date: '2 years ago',
      text: 'The finished product was very good, and they got it done quickly once I got my van in. Just want to say thank you to Rebecca.'
    }
  ];
  ...
  function insertTrustSection() {
    ...
    section.innerHTML = `
      ...
      <div class="review-carousel" data-review-carousel aria-label="Customer review carousel">
      ...
      <div class="container">
        <div class="review-trust-actions" data-reveal>
          <a class="btn" href="contact.html">Turn Reviews Into Trust</a>
    ...
    window.setTimeout(function () {
      ...
      if (window.gsap) {
        const tween = window.gsap.to(track, {
          x: -distance,
          duration: Math.max(42, distance / 42),
          ease: 'none',
          repeat: -1,
          modifiers: {
            x: function (x) {
        ...
        carousel.addEventListener('mouseenter', function () { tween.pause(); });
        carousel.addEventListener('mouseleave', function () { tween.resume(); });
        carousel.addEventListener('focusin', function () { tween.pause(); });
        carousel.addEventListener('focusout', function () { tween.resume(); });
      } else {
